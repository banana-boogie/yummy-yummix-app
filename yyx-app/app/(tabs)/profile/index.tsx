          ...
          <View className="mt-md px-md">
            ...
            <View className="flex-row items-center mb-xxs">
              <ImageUpload
                ...
                buttonClassName="w-[100px] h-[100px] md:w-[120px] md:h-[120px] shrink-0 -mt-sm"
              />
      ...
      <View className="w-full max-w-[800px] self-center px-md">
        {isAdmin ? (
          <View className="mb-lg">
            <Button
              ...
              className="bg-primary-dark rounded-sm flex-row items-center"
              textClassName="text-neutral-white text-base font-bold"
              icon={<Ionicons name="shield-checkmark" size={24} color={COLORS.neutral.white} className="mr-md" />}
            />
          </View>
        ) : null}
        <View
        ...
        >
          {featureButtons.map((button) => (
            <TouchableOpacity
              key={button.id}
              className="w-[48%] md:w-[30%] bg-background-default rounded-md p-md mb-lg items-center justify-center shadow-md"
            ...
            >
              ...
              <Text
                preset="handwritten"
                className="text-lg text-center text-text-default"
              >
                {button.title}
              </Text>
            </TouchableOpacity>
