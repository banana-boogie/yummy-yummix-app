...
const translations = {
  en: {
    ...
    shoppingList: {
      ...
      allDone: 'All Done!',
      allDoneDescription: 'Your shopping list is empty. Tap the + button to add items.',
  ...
  es: {
    ...
    shoppingList: {
      ...
      allDone: '¡Todo Listo!',
      allDoneDescription: 'Tu lista de compras está vacía. Toca el botón + para agregar artículos.',
