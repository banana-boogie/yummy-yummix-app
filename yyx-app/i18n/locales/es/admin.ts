export const admin = {
  ...
  contentHealth: {
    ...
    missingNutrition: "Nutricion Faltante",
    unpublished: "Sin Publicar",
    recipes: "recetas",
    ingredients: "ingredientes",
    usefulItems: "elementos utiles",
    filterAll: "Todo",
    filterTranslation: "Traduccion",
    filterImage: "Imagen",
    filterNutrition: "Nutricion",
    filterUnpublished: "Sin Publicar",
    filterRecipes: "Recetas",
    filterIngredients: "Ingredientes",
    filterUsefulItems: "Elementos Utiles",
    noEn: "Sin EN",
    noEs: "Sin ES",
    noImage: "Sin Imagen",
    noNutrition: "Sin Nutricion",
    draft: "Borrador",
    fix: "Editar",
    publish: "Publicar",
    publishReady: "Lista para publicar",
    publishNotReady: "No lista",
    hasEnName: "Nombre en ingles",
    hasEsName: "Nombre en espanol",
    hasImage: "Imagen",
    hasSteps: "Pasos",
