export const recipes = {
  ...
  addToPlan: {
    title: "Add to Plan",
    noPlanPrompt: "No active plan yet. Create one first?",
    createPlanCta: "Create a plan",
    selectSlot: "Pick a day and meal",
    successToast: "Added to your plan",
    errorToast: "Couldn't add to plan. Please try again.",
    cancel: "Cancel",
    weekComingSoon: "Week tab coming soon",
  },
  header: {
    greeting: "Hi, {{name}}!",
