...
// Memoized at module level to avoid recreating on every render
...
function createMarkdownRules(recipes?: RecipeCard[]) {
...
// Memoized message item component for better FlatList performance
