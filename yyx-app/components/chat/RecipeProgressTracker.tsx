 ...
 *
 * Current baseline: ~12s total (GPT-4.1, measured Mar 2026)
 * Tracker is visible for ~12-15s (tool_exec + stream + finalize).
 */
export const PROGRESS_CONFIG = {
    stages: [
        { key: 'understanding', icon: 'lightbulb-outline' as const, i18nKey: 'chat.progressTracker.stage1', durationMs: 1000 },
        { key: 'ingredients', icon: 'basket-outline' as const, i18nKey: 'chat.progressTracker.stage2', durationMs: 3000 },
        { key: 'cookingTimes', icon: 'timer-outline' as const, i18nKey: 'chat.progressTracker.stage3', durationMs: 3000 },
        { key: 'steps', icon: 'clipboard-text-outline' as const, i18nKey: 'chat.progressTracker.stage4', durationMs: 4000 },
        { key: 'finalTouches', icon: 'star-four-points-outline' as const, i18nKey: 'chat.progressTracker.stage5', durationMs: 3000 },
