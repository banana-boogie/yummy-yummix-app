...
export function IrmixyCookingModal({
  ...
  const [localVoiceTranscriptMessages, setLocalVoiceTranscriptMessages] =
    useState<ChatMessage[]>([]);

  const sessionId =
    externalSessionId !== undefined ? externalSessionId : localSessionId;
  ...
  const voiceTranscriptMessages =
    externalVoiceTranscriptMessages ?? localVoiceTranscriptMessages;
  const setVoiceTranscriptMessages =
    onExternalVoiceTranscriptMessagesChange ?? setLocalVoiceTranscriptMessages;
  ...
  return (
    ...
    >
      <View className="flex-1 bg-background-default">
        ...
        <View
          onLayout={(e) => setHeaderAreaHeight(e.nativeEvent.layout.height)}
        >
          {/* Header */}
          <View
          ...
          {isNative && (
            <View className="flex-row items-center justify-center py-xs px-md bg-primary-lightest">
              ...
              >
                ...
                <Text
                  preset="bodySmall"
                  className="text-primary-darkest font-semibold"
                >
                  {mode === "text"
                    ? i18n.t("chat.cookingModal.switchToVoice")
                    : i18n.t("chat.cookingModal.switchToText")}
