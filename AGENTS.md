...
5. **Prefer built-in solutions** - Use native APIs and existing project utilities over new dependencies; only add a package when no built-in alternative exists
...
1. Read [TESTING.md](./TESTING.md) for patterns and conventions
