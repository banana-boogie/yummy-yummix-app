-- Fix: user_profiles has no 'username' column. Use 'email' as fallback instead.
-- Affects: admin_ai_chat_session_depth, admin_top_viewed_recipes, admin_top_cooked_recipes

-- 1. Fix admin_ai_chat_session_depth
...
-- 2. Fix admin_top_viewed_recipes
...
-- 3. Fix admin_top_cooked_recipes
