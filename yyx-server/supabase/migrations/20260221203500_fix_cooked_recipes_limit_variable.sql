-- Fix: "argument of LIMIT must not contain variables"
-- Postgres does not allow CTE column references in LIMIT.
-- Replace LIMIT p.limit_rows with the function parameter directly.
