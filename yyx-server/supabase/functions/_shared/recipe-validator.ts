                ...
                properties: {
                    ...
                    measurement_unit: {
                        ...
                        properties: {
                            ...
                            system: { type: 'string', enum: ['metric', 'imperial', 'universal'] },
                            name_en: { type: 'string' },
...
export function validateRecipeData(data: unknown): ValidationResult {
    ...
    } else if (!['easy', 'medium', 'hard'].includes(recipe.difficulty as string)) {
    ...
    if (Array.isArray(recipe.ingredients)) {
        recipe.ingredients.forEach((ing: any, index: number) => {
            ...
            if (!ing.ingredient || (!ing.ingredient.name_en && !ing.ingredient.name)) {
