 ...
 * Unlike normalizeMessagesForAi(), this preserves native tool messages so the AI
 * stays grounded in its tool-calling behavior rather than seeing text summaries.
 */
